...
import { Phone, Mail, MapPin, ArrowRight, CreditCard, Banknote, Smartphone, ShieldCheck } from "lucide-react";
...
const paymentMethods = [
  ...
  { name: "COD", icon: ShieldCheck },
];

export function Footer() {
  return (
    <footer className="border-t bg-gradient-to-b from-background via-background to-muted/50">
      {/* Trust / Payment strip */}
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
            {paymentMethods.map((method) => (
              ...
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-background shadow-sm ring-1 ring-border/40">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            <div>
              ...
              <div className="mt-1.5 h-0.5 w-10 rounded-full bg-gradient-to-r from-secondary to-secondary/30" />
            ...
            <div className="flex gap-3 pt-1">
              {siteConfig.social.instagram && (
                <a
                  ...
                  className="group flex h-10 w-10 items-center justify-center rounded-xl border bg-background text-muted-foreground transition-all hover:border-primary hover:text-primary hover:shadow-md hover:-translate-y-0.5"
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="h-0.5 w-8 rounded-full bg-secondary/40" />
            <nav className="flex flex-col gap-2.5">
              {quickLinks.map((link) => (
                ...
                >
                  <ArrowRight className="h-3 w-3 opacity-0 -translate-x-2 transition-all group-hover:opacity-100 group-hover:translate-x-0 text-secondary" />
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3.5">
              ...
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
                ...
                <a href={`tel:${siteConfig.phone}`} className="hover:text-primary transition-colors font-medium">
                  {siteConfig.phone}
                </a>
              </div>
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
